...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'pintores');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Pintores');
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://www.cssigniter.com/support/viewtopic.php?f=50&t=2034');
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=50');
